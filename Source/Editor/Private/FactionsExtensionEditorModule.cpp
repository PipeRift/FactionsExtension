...
#include "FactionsExtensionEditorModule.h"
...
void FFactionsExtensionEditorModule::StartupModule()
{
...
void FFactionsExtensionEditorModule::ShutdownModule()
{
...
void FFactionsExtensionEditorModule::RegisterPropertyTypeCustomizations()
{
...
void FFactionsExtensionEditorModule::PrepareAutoGeneratedDefaultEvents() {}


void FFactionsExtensionEditorModule::RegisterCustomClassLayout(
...
void FFactionsExtensionEditorModule::RegisterCustomPropertyTypeLayout(
...
template <class T>
void FFactionsExtensionEditorModule::RegisterCustomPinFactory()
{
...
IMPLEMENT_GAME_MODULE(FFactionsExtensionEditorModule, FactionsExtensionEditor);