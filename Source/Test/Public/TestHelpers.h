...
DECLARE_DELEGATE_OneParam(FFactionsTestOnWorldReady, UWorld*);

class FFactionsSpec : public FAutomationSpecBase
{
...
public:
	...
	FFactionsSpec(const FString& InName, const bool bInComplexTask)
...
protected:
	...
	void PrepareTestWorld(FFactionsTestOnWorldReady OnWorldReady);
